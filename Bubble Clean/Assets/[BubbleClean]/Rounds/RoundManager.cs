...
public class RoundManager : MonoBehaviour
{
    ...
    // Índice de la música para la ronda 5 (especificado en el inspector)
    ...
    public void NextRound()
    {
        ...
        if (currentRound == 5)
        {
            MusicClass.Instance.PlaySpecificMusic(musicIndexForRound5);  // Cambia la música con el índice especificado
            Debug.Log("Música cambiada en la ronda 5.");
        }
